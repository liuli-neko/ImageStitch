...
target("ImageStitchCore")
    ...
    add_packages("opencv", "eigen", "glog", "nlohmann_json", "easyexif")
		add_files("../third-party/easyexif/exif.cpp")
		add_includedirs("../third-party/easyexif/")
    add_headerfiles("imageStitcher/*.h")
